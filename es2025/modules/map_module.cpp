...
namespace spectre::es2025 {
    ...
    MapModule::Value::Value() : m_Scalar(), m_Kind(Kind::Undefined), m_String() {
    }

    MapModule::Value::Value(const Value &other) : m_Scalar(), m_Kind(Kind::Undefined), m_String() {
        Assign(other);
    }

    MapModule::Value::Value(Value &&other) noexcept : m_Scalar(), m_Kind(Kind::Undefined), m_String() {
        Assign(std::move(other));
    }

    MapModule::Value &MapModule::Value::operator=(const Value &other) {
        if (this != &other) {
            Assign(other);
        }
        return *this;
    ...
    MapModule::Value &MapModule::Value::operator=(Value &&other) noexcept {
        if (this != &other) {
            Assign(std::move(other));
        }
        return *this;
    ...
    MapModule::Value::~Value() = default;

    MapModule::Value MapModule::Value::Undefined() {
        Value v;
        v.Reset();
        return v;
    }

    MapModule::Value MapModule::Value::FromBoolean(bool v) {
        Value value;
    ...
    MapModule::Value MapModule::Value::FromInt(std::int64_t v) {
        Value value;
    ...
    MapModule::Value MapModule::Value::FromDouble(double v) {
        Value value;
    ...
    MapModule::Value MapModule::Value::FromHandle(Handle v) {
        Value value;
    ...
    MapModule::Value MapModule::Value::FromString(std::string_view text) {
        Value value;
    ...
    bool MapModule::Value::IsUndefined() const noexcept {
        return m_Kind == Kind::Undefined;
    }

    bool MapModule::Value::IsBoolean() const noexcept {
        return m_Kind == Kind::Boolean;
    }

    bool MapModule::Value::IsInt() const noexcept {
        return m_Kind == Kind::Int64;
    }

    bool MapModule::Value::IsDouble() const noexcept {
        return m_Kind == Kind::Double;
    }

    bool MapModule::Value::IsString() const noexcept {
        return m_Kind == Kind::String;
    }

    bool MapModule::Value::IsHandle() const noexcept {
        return m_Kind == Kind::Handle;
    }

    bool MapModule::Value::Boolean() const noexcept {
        return m_Scalar.booleanValue;
    }

    std::int64_t MapModule::Value::Int() const noexcept {
        return m_Scalar.intValue;
    }

    double MapModule::Value::Double() const noexcept {
        return m_Scalar.doubleValue;
    }

    MapModule::Handle MapModule::Value::HandleValue() const noexcept {
        return m_Scalar.handleValue;
    }

    std::string_view MapModule::Value::String() const noexcept {
        return m_String;
    }

    void MapModule::Value::Assign(const Value &other) {
        m_Kind = other.m_Kind;
        switch (other.m_Kind) {
            case Kind::Undefined:
    ...
    void MapModule::Value::Assign(Value &&other) noexcept {
        m_Kind = other.m_Kind;
        switch (other.m_Kind) {
            case Kind::Undefined:
                m_Scalar.handleValue = 0;
    ...
    void MapModule::Value::Reset() noexcept {
        m_Kind = Kind::Undefined;
        m_Scalar.handleValue = 0;
        m_String.clear();
    }

    bool MapModule::Value::Equals(const Value &other) const noexcept {
    ...
    StatusCode MapModule::Set(Handle handle, const Value &key, const Value &value) {
        ...
        if (index != kInvalidIndex) {
            record->entries[index].value.Assign(value);
            Touch(*record);
            if (collision) {
    ...
    std::uint32_t MapModule::Locate(const MapRecord &record, const Value &key, std::uint64_t hash,
        ...
        while (true) {
            ...
            if (entryIndex == kDeletedIndex) {
                ...
                if (entry.active && entry.hash == hash && entry.key.Equals(key)) {
                    bucket = index;
                    collision = probes != 0;
                    return entryIndex;
                }
